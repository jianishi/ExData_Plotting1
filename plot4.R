...
par(mfrow=c(2,2))
with(data2,plot(x=data2$time4,y=data2$Global_active_power,type = "l",ylab="Global Active Power"))
with(data2,plot(x=data2$time4,y=data2$Voltage,type = "l"))
...
with(data2,plot(x=data2$time4,y=data2$Global_reactive_power,type = "l"))
dev.off()